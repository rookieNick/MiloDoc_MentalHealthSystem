                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    if ($status == "Pending") {
                                        $statusColor = "color: #ffcc00; font-weight: bold;"; // Yellow
                                    } elseif ($status == "Completed") {
                                        $statusColor = "color: green; font-weight: bold;"; // Green
                                    } elseif ($status == "Missed" || $status == "Cancelled") {
                                        $statusColor = "color: red; font-weight: bold;"; // Red
                                    }
                                    ...
                                    echo '<tr >
                                        ...
                                        substr($pname,0,25)
                                        .'</td >
                                        <td style="text-align:center;font-size:15px;font-weight:500; color: var(--btnnicetext);'.$statusColor.'">'.$status.'
                                       ...
                                       &nbsp;&nbsp;&nbsp;-->
                                        <a href="?action=confirm&id='.$appoid.'&name='.$pname.'&session='.$title.'&apponum='.$apponum.'" class="non-style-link confirm-btn"  data-status="'.$status.'">
                                            <button class="btn-primary-soft btn button-icon btn-edit" style="padding-left: 30px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;">
            ...
            <div id="popup1" class="overlay">
                <div class="popup">
                    <center>
                        ...
                        <a class="close" href="appointment.php">&times;</a>
                        <div class="content">
                            You want to confirm this appointment<br><br>
                            Patient Name: &nbsp;<b>'.substr($nameget,0,40).'</b><br>
                            Appointment number &nbsp; : <b>'.substr($apponum,0,40).'</b><br><br>
                        </div>
                        <div style="display: flex;justify-content: center;">
                            <a href="confirm-appointment.php?id='.$id.'" class="non-style-link">
        ...
        confirmButtons.forEach(function (btn) {
            btn.addEventListener("click", function (e) {
                ...
                if (status === "Cancelled" || status === "Completed") {
                    ...
                    alert("You cannot confirm an appointment that is already " + status + ".");
                }
            });
        });
    });
