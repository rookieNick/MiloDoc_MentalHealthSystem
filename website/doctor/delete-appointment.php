<?php
    ...
    if($_GET){
        ...
        //set status to cancelled and googleCalendarId to null
        $sqlmain = "UPDATE appointment SET status = 'Cancelled', googleCalendarId = NULL, googleCalendarId_doctor = NULL WHERE appoid=?";
