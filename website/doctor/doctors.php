...
<body>
    ...
    if (isset($_GET['error'])) {
        ...
        switch ($error) {
            case '0':
                $message = '<div class="success-msg">Doctor details updated successfully.</div>';
                break;
            case '1':
                $message = '<div class="error-msg">Please fill in all required fields.</div>';
                break;
            case '2':
                $message = '<div class="error-msg">Passwords do not match.</div>';
                break;
            case '3':
                $message = '<div class="error-msg">No form data received.</div>';
                break;
            case '4':
                $message = '<div class="error-msg">Invalid name. Only letters and spaces allowed.</div>';
                break;
            case '5':
                $message = '<div class="error-msg">Invalid NIC format.</div>';
                break;
            case '6':
                $message = '<div class="error-msg">Invalid telephone number.</div>';
                break;
            case '7':
                $message = '<div class="error-msg">Invalid email address format.</div>';
                break;
            case '8':
                $message = '<div class="error-msg">Password must be at least 6 characters.</div>';
                break;
            case '9':
                $message = '<div class="error-msg">New email already exists in the system.</div>';
                break;
            case '10':
                $message = '<div class="error-msg">Email must be a valid Gmail address (e.g., user@gmail.com).</div>';
                break;
            default:
        }
            ...
            <div id="popup1" class="overlay">
                <div class="popup">
                    <center>
                        ...
                        <div style="display: flex;justify-content: center;">
                            <div class="abc">
                                <form action="edit-doc.php" method="POST" class="add-new-form" id="editDoctorForm">
